...
FinePrint.configure do |config|
  ...
  # Default: "/"
  config.sign_in_path = '/connect/sessions/new'
  ...
  # config.controller_base_class = ::ApplicationController
  
end

class FinePrint::ApplicationController < ActionController::Base
  helper ApplicationAccountBarHelper, ApplicationHelper, ApplicationTopNavHelper, AlertHelper
